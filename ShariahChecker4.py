...
openai.api_key = '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'
...
"STATEMENTS OF FINANCIAL POSITION", "BALANCE SHEETS", "CONSOLIDATED STATEMENT OF FINANCIAL POSITION"]
            ...
            # Visualizing COA and DOA using a bar chart
            metrics = ['COA', 'DOA']
            values = [COA, DOA]
            threshold = 33.0
            ...
            ax.bar(metrics, values, color=['blue', 'orange'])
             ...
             # Adding a horizontal line for the 33% threshold
